...
const abouttext =   <p> <p>This project was carried out as part of my Internship with AVL. The original idea was to create
                        ...
                        side using the Java Interface for MATLAB while on the other side of the network there is an asyncrhonous Python function
                        ...
                        integrated as the Front-End of the Application which are also running asyncrhonously in the main program</p>
